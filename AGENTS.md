...
3. **Parallel Processing**: Video chunks are sent concurrently to the Gemini API (`gemini-3.6-flash` by default). Overlap clip creation is auto-sized from CPU count.
